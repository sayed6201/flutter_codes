...
class VolListScreen extends StatefulWidget {
  static final String tag = "VolListScreen";
  VolListScreen();
  @override
  _VolListScreenState createState() => _VolListScreenState();
}

class _VolListScreenState extends State<VolListScreen> {
  ...
  void didChangeDependencies() async {
    ...
    if (_isInit) {
      catagoryInfo =  Provider.of<GuestProvider>(context,listen: false).getSelectedCategoryInfo;
      print("isloading $_isLoading");
      await Provider.of<GuestProvider>(context,listen: false).fetchVolListByCatagory();
      _isInit = false;
      if(mounted){
        setState(() {
          _isLoading = false;
  ...
  Widget build(BuildContext context) {
    ...
    voList = Provider.of<GuestProvider>(context).getVolList;
    
    setState(() {
      header_text = "${voList.length ?? ""} Volunteers found";
    });
    print("voList-length-ui:  ${voList.length}");
                                                            ...
                                                            children: <Widget>[
                                                              Row(
                                                                children: <Widget>[
                                                                  Flexible(
                                                                    child: Text(
                                                                      "Name: "+voList[index]["volunteer_name"]??"Sayed",
                                                                      style: TextStyle(
                                                              ...
                                                              Row(
                                                                ...
                                                                children: <Widget>[
                                                                  Flexible(
                                                                    child: Column(
                                                                      children: <Widget>[
                                                                        Text("Profession: ${voList[index]["occupation_name"] ?? "N/A"}",
                                                                        ...
                                                                        SizedBox(height: SizeConfig.blockSizeVertical * 1,),
                                                                        Text("Institute: ${voList[index]["instituation_name"] ?? "N/A"}",
                                                                            textAlign: TextAlign.left,
                                                                            style: TextStyle(
                                                                              color: Colors.black38,
                                                                              fontSize: SizeConfig.blockSizeVertical * 1.5,
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    Column(
                                                                      children: <Widget>[
                                                                        ...
                                                                        if(voList[index]["status"] == "Platinum")
                                                                          Container(
                                                                            padding: EdgeInsets.symmetric(horizontal: 5, vertical: 2),
                                                                            decoration: BoxDecoration(
                                                                              color:Colors.blue,

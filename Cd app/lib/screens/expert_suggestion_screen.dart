...
class ExpertSuggestionPostScreen extends StatefulWidget {
  static const String tag = "/ExpertSuggestionPostScreen";
  @override
  _ExpertSuggestionPostScreenState createState() => _ExpertSuggestionPostScreenState();
}

class _ExpertSuggestionPostScreenState extends State<ExpertSuggestionPostScreen> {
      ...
      ListView(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
                "Please make sure you suggest error free tips, because we won't allow editing once the suggestion is dubmitted to the patient",
  ...
  void validation() async{
    ...
    if (_formKey.currentState.validate()) {
      ...
      try{
        ...
        await Provider.of<AuthProvider>(context, listen: false).postSuggestion(
          sug: suggestionController.text.toString().trim()
        );
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Align(
                      alignment: Alignment.center,
                      child: Text(msg[SUCCESS_POST_SUGGESTION],
                        textAlign: TextAlign.center,),
                    )
                  ],
                )

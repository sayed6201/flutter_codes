...
class VolunteerProfileView extends StatefulWidget {
  ...
  static final String tag = "VolunteerProfileView";
...
class _VolunteerProfileViewState extends State<VolunteerProfileView> {
  ...
  var _isLoading = true;
  var avgRating;
  var header_text = "VOLUNTEER'S PROFILE";
  var mode_flag = "1";


  Map<String,dynamic> volInfo = {};
  ...
  void didChangeDependencies() async {
    ...
    if (_isInit) {
      ...
      avgRating = await Provider.of<AuthProvider>(context,listen: false).fetchVolAvgRating(mode: mode_flag);
      await Provider.of<AuthProvider>(context,listen: false).fetchVolReviews(mode: mode_flag);
  ...
  Widget build(BuildContext context) {
    ...
    print("Vol Mode:  $mode_flag");
    if(mode_flag == "1"){
      volInfo =  Provider.of<AuthProvider>(context).getAData;
      setState(() {
        header_text = "My Profile";
      });
    }else{
      volInfo =  Provider.of<AuthProvider>(context).getVolData;
      setState(() {
        header_text = "VOLUNTEER'S PROFILE";
      });
    }
...
//    });
    print("Vol Data-length-ui:  ${volInfo.toString()}");
